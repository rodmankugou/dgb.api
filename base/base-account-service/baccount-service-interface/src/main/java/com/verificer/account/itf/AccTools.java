...
//        return new StringBuilder(USER_REFERRER).append("_").append(userId.toString()).toString();
//    }
//
//    private String getShopSettleSubName(String shopId){
//        return new StringBuilder(SHOP_SETTLE).append("_").append(shopId).toString();
//    }
